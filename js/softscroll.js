...
var SoftScroll=
{
 ...
 timer:null, lastX:-1, lastY:-1, xHalted:false, yHalted:false, step:50, targetDisp:null, stepTarget:{x:0,y:0}, logged:5, startJump:location.href.match(/#([^\?]+)\??/), currentAnchor:null, initialised:false, initialTarget:"", showHref:false, excludeClass:/\bnoSoftScroll\b/i, targetFrame:self, 

 //////////////////////////
 /* delay: 300, proportion:3 */
  delay:50,  proportion:20,
 //////////////////////////
 ...
 installHandler : function(){ /*jgfytydgtr864nghffdydrhgf4*/ },
